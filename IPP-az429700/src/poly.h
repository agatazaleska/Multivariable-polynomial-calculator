...
/**
 * Sumuje listę jednomianów i tworzy z nich wielomian.
 * Wykonuje głębokie kopie wielomianów z tablicy @p monos.
 * Nie przejmuje na właśność tablicy @p monos ani jej zawartośći.
 * @param[in] count : liczba jednomianów
 * @param[in] monos : tablica jednomianów
 * @return wielomian będący sumą jednomianów
 */
...
/**
 * Sumuje listę jednomianów i tworzy z nich wielomian.
 * Przejmuje na własność zawartość tablicy @p monos oraz tablicę.
 * @param[in] count : liczba jednomianów
 * @param[in] monos : tablica jednomianów
 * @return wielomian będący sumą jednomianów
 */
...
/**
* Wykonuje operacje składania wielomianu.
* Podstawia wielomian q[i] pod zmienną xi wielomoanu p,
* lub 0 jeśli i >= k.
* Wynikiem złożenia jest wielomian p(q[0], q[1], ...).
* @param[in] p : wielomian
* @param[in] k : ilość wielomianów składanych z p
* @param[in] q[] : tablica wielomianów składanych z p
* @return wielomian będący wynikiem operacji złożenia
*/
...
/**
* Podnosi wielomaiam do potęgi exp.
* @param[in] p : wielomian
* @param[in] exp : potęga
* @return p^exp
*/
